...
function registerCommands(
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand('codepadi.connect', async (treeItem) => {
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand('codepadi.disconnect', async (treeItem) => {
            let serverId: string | undefined;
    ...
    // Add server command
    context.subscriptions.push(
        vscode.commands.registerCommand('codepadi.addServer', async () => {
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand('codepadi.removeServer', async (treeItem) => {
            let serverId: string | undefined;
    ...
    // Show logs command
    context.subscriptions.push(
        vscode.commands.registerCommand('codepadi.showLogs', () => {
            Logger.show();
        })
    );
}
